...
export const COMIDA_FUERTES: FoodItem[] = [
  ...
  { name: "Bratwurtz", description: "Salchicha artesanal (elige tu salchicha) con una base de miel picante, pepinillos encurtidos, repollo encurtido y mayonesa de la casa. Viene con papas rústicas.", price: "$29.000", image: "https://framerusercontent.com/images/M40ViTWpKxa2YB9ew0usHOOmfk.webp", spicy: true },
];
...
export const COMIDA_COMPARTIR: FoodItem[] = [
  ...
  { name: "Tostadas de Chicharrón", description: "3 tortillas de maíz amarillo, con chicharrón carnudo, pico de gallo y salsa chipotle.", price: "$36.000", image: "https://framerusercontent.com/images/QgkzGCJeEZhkhLT7EdmPFMskC4E.webp", spicy: true },
  { name: "Tacos de Morillo", description: "3 tortillas de maíz morado, con carne de morillo, pico de gallo y salsa de chipotle.", price: "$36.000", image: "https://framerusercontent.com/images/Nb45bUKHiU6LRJDKoISIOun4rBI.webp", spicy: true },
